...
contract Staking is Ownable {
    ...
    */
    ...
    function releaseStake(address _tokenAddr,  address[] calldata _stakers,  uint[] calldata _amounts,address _dest) isMediator(_tokenAddr) isValidToken(_tokenAddr) external returns (bool){
