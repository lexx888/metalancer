...
async function getNetworkMetadata(network, tokens, overwrite) {
  ...
  console.log("registry :: getNetworkMetadata");
  ...
  const multicallContract = {
    ...
    metis: "0xd8F763e9778CDcEaD5c7A795120ED6f8B7af537d"
  };

  const provider = providers[network];
  const multicallAddress = "0xd8F763e9778CDcEaD5c7A795120ED6f8B7af537d";
